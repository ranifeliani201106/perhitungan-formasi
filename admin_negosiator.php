...
<div class="container mt-5">
    <h2 class="text-center mb-4">Hasil Perhitungan Negosiator Perdagangan</h2>
                ...
                <?php if (count($hasil) > 0): ?>
                    <?php foreach ($hasil as $index => $row): ?>
                        <tr>
                            ...
                            <td class="d-flex">
                                <a href="edit_negosiator.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning me-2">Edit</a>
                            </td>
            ...
            <?php if (count($verifikasi) > 0): ?>
                <?php foreach ($verifikasi as $index => $row): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['keterangan']); ?></td>
                        <td class="d-flex">
                                <a href="hapus_negosiator.php?id=<?php echo $row['id']; ?>"
...
<footer class="mt-auto bg-dark text-white text-center py-3">
    <p class="mb-0">© 2024 Admin Panel - Hasil Negosiator Perdagangan</p>
</footer>
