...
<head>
    ...
    <title>Admin - Hasil Penguji Mutu Barang</title>
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Hasil Penguji Mutu Barang</h2>
    ...
    <?php if (count($hasil) > 0): ?>
        <?php foreach ($hasil as $index => $row): ?>
            <tr>
                ...
                <td class="d-flex">
                    <a href="edit_penguji.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning me-2">Edit</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else: ?>
    ...
    <?php if (count($verifikasi) > 0): ?>
        <?php foreach ($verifikasi as $index => $row): ?>
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['keterangan']); ?></td>
                <td class="d-flex">
                    <a href="hapus_penguji.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?');">Hapus</a>
                </td>
            </tr>
        <?php endforeach; ?>
    <?php else: ?>
...
<footer class="mt-auto bg-dark text-white text-center py-3">
    <p class="mb-0">© 2024 Admin Panel - Hasil Penguji Mutu Barang</p>
</footer>
