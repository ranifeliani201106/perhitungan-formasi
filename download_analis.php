...
header("Content-Disposition: attachment; filename=hasil_perhitungan_analis.xls");
...
echo "<style>
    table {
        ...
        width: 100%;
        margin-top: 40px; /* Menambahkan jarak antara judul dan tabel */
    }
    th, td {
    ...
    h5 {
        text-align: center;
        margin: 20px 0; /* Tambahkan margin untuk nama instansi */
    }
</style>";
echo "</head>";
echo "<body>";
echo "<h2>Hasil Perhitungan Analis Perdagangan</h2>"; // Tambahkan judul
echo "<h5>" . $_SESSION['namainstansi'] . "</h5>"; // Nama instansi
