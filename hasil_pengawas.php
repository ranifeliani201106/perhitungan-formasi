...
<div class="offcanvas offcanvas-start bg-success" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
  ...
  <div class="offcanvas-body">
    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
      <li class="nav-item">
        <a class="nav-link text-white" href="dashboar_user.php">Home</a>
      </li>
...
<div class="container mt-5">
    <h2 class="text-center">Pengawas Perdagangan</h2>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php
            $query = "SELECT * FROM hasil_pengawas";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><a href='hapus_pengawas.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus?')\">Hapus</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
    </table>
    <a href="download_pengawas.php" class="btn btn-success">Download </a>
    <!-- Tombol Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formTambahData" method="post" action="pengawasperdagangan.php">
...
<script>
    const deskripsiMap = {
        "pengawasan  kegiatan perdagangan": "jumlah hasil pengawasan kegiatan perdagangan dalam waktu 1 tahun yang dituangkan dalam laporan hasil pengawasan",
        "pengawasan Barang Beredar dan/atau Jasa": "jumlah hasil pengawasan barang beredar dan/atau jasa dalam waktu 1 tahun yang dituangkan dalam laporan hasil pengawasan",
        "pengawasan Alat Ukur, Alat Takar, Alat Timbang, dan Alat Perlengkapan": "Jumlah hasi pengawasan Alat Ukur, Alat Takar, Alat Timbang, dan Alat Perlengkapan dalam waktu 1 tahun yang dituangkan dalam laporan Hasil Pengawasan serta dilampiri dengan berita acara hasil pengawasan dan cerapan",
        "pengawasan BDKT": "Jumlah hasi pengawasan Barang Dalam Keadaan Terbungkus dalam waktu 1 tahun yang dituangkan dalam laporan Hasil Pengawasan serta dilampiri dengan berita acara hasil pengawasan dan cerapan",
        "pengawasan penggunaan satuan ukuran": "Jumlah hasil pengawasan Satuan Ukuran dalam waktu 1 tahun yang dituangkan dalam laporan Hasil Pengawasan serta dilampiri dengan berita acara hasil pengawasan dan cerapan",
        "Pengawasan Perdagangan Berjangka Komoditi, Sistem Resi Gudang dan Pasar Lelang Komoditas": "Jumlah hasil pemeriksaan/pemeriksaan teknis kegiatan Perdagangan Berjangka Komoditi, Sistem Resi Gudang, dan Pasar Lelang Komoditas dalam waktu 1 tahun yang dituangkan dalam laporan Hasil Pemeriksaan ",
        "Penanganan Pengaduan": "jumlah pengaduan pelanggaran yang ditangani dalam waktu 1 Tahun",
        "Tindak lanjut hasil pengawasan": "jumlah rekomendasi pemberian sanksi administratif/tindak lanjut yang diterbitkan dalam waktu 1 tahun",
        "Penyidikan": "Jumlah pelaksanaan penyidikan sesuai ketentuan sebagai tindaklanjut proses penegakan hukum di bidang Perdagangan dihitung berdasarkan SPDP yang diterbitkan dalam waktu 1 tahun",
        "Penindakan": "Jumlah kegiatan penindakan secara langsung karena ditemukan adanya pelanggaran berdasarkan  hasil pengawasan",
    };
